...
const Hero = () => {
  ...
  return (
    <div className="relative opacity-0 hero z-20 w-full max-w-4xl mx-auto mt-24 px-7 md:mt-24 lg:mt-36 xl:px-0">
      <div className="flex items-center md:flex-row flex-col-reverse">
        <div className="relative description w-full md:w-1/2">
          <h1 className="mb-3 title hidden md:block text-4xl font-bold leading-tight md:text-4xl lg:text-5xl dark:text-white">
            Hello, I'm Diandra.
          </h1>
        ...
        <div className="relative justify-end w-full md:flex md:pl-10 md:w-1/2 md:mt-0 md:translate-y-4 xl:translate-y-0 mb-3">
          <h1 className="mb-7 title md:hidden text-4xl font-bold leading-tight md:text-4xl lg:text-5xl dark:text-white">
            Hello, I'm Diandra.
          </h1>
          <div className="absolute emoji bottom-0 z-40 w-16 h-16 md:-translate-x-[21.9rem] -translate-x-6 translate-y-12 md:-translate-y-1/2 lg:top-auto top-0 lg:-translate-y-[330px] rounded-full">
          ...
          <div className="relative z-30">
            <Image
              className="relative pointer-events-none image z-30 w-96 md:max-w-md mx-auto dark:-translate-y-0.5"
              src="/img/saya.png"
              loading="lazy"
              width={500}
              height={500}
              alt="diandra rullyaditya"
            />
            <div className="absolute image bottom-2 right-0 z-20 w-full h-full lg:h-[420px] translate-x-0 -translate-y-px border border-dashed rounded-2xl bg-gradient-to-r dark:from-neutral-950 dark:via-black dark:to-neutral-950 from-white via-neutral-50 to-white border-neutral-300 dark:border-neutral-700"></div>
          </div>
        </div>
      </div>
    </div>
